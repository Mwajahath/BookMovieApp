...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        // xhr.open("GET", "http://localhost:3000/movies.json");
        ...
        // xhrReleased.open("GET", "http://localhost:3000/movies.json");
        ...
        // xhrGenres.open("GET", "http://localhost:3000/genres.json");
        ...
        // xhrArtists.open("GET", "http://localhost:3000/artists.json");
    ...
    filterApplyHandler = () => {
        ...
        //xhrFilter.open("GET","http://localhost:3000/filteredMovies.json")
                    ...
                    <div className="right">
                        <Card>
                            <CardContent>
                                ...
                                <br /><br />
                                <FormControl className={classes.formControl}>
                                    <Button onClick={() => this.filterApplyHandler()}
